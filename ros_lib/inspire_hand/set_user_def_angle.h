#ifndef _ROS_SERVICE_set_user_def_angle_h
#define _ROS_SERVICE_set_user_def_angle_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SET_USER_DEF_ANGLE[] = "inspire_hand/set_user_def_angle";

  class set_user_def_angleRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SET_USER_DEF_ANGLE; };
    const char * getMD5(){ return "3ca0fd0f21baa0c9269de1034273b80d"; };

  };

  class set_user_def_angleResponse : public ros::Msg
  {
    public:
      typedef bool _angle_accepted_type;
      _angle_accepted_type angle_accepted;

    set_user_def_angleResponse():
      angle_accepted(0)
    {
    }
