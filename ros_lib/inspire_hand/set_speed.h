#ifndef _ROS_SERVICE_set_speed_h
#define _ROS_SERVICE_set_speed_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SET_SPEED[] = "inspire_hand/set_speed";

  class set_speedRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SET_SPEED; };
    const char * getMD5(){ return "9b81c1887290eb799831f63509865cac"; };

  };

  class set_speedResponse : public ros::Msg
  {
    public:
      typedef bool _speed_accepted_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      u_speed_accepted.real = this->speed_accepted;
      *(outbuffer + offset + 0) = (u_speed_accepted.base >> (8 * 0)) & 0xFF;
      offset += sizeof(this->speed_accepted);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_speed_accepted.base = 0;
      u_speed_accepted.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->speed_accepted = u_speed_accepted.real;
      offset += sizeof(this->speed_accepted);
     return offset;
    }

    const char * getType(){ return SET_SPEED; };
    const char * getMD5(){ return "9bb3ff7624b31e52edd1d0b2bbbae418"; };
