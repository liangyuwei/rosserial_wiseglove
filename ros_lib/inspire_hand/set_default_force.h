#ifndef _ROS_SERVICE_set_default_force_h
#define _ROS_SERVICE_set_default_force_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SET_DEFAULT_FORCE[] = "inspire_hand/set_default_force";

  class set_default_forceRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SET_DEFAULT_FORCE; };
    const char * getMD5(){ return "3c8721b68bc7d5e3d85bff9ad38312ed"; };

  };

  class set_default_forceResponse : public ros::Msg
  {
    public:
      typedef bool _default_force_accepted_type;
      _default_force_accepted_type default_force_accepted;

    set_default_forceResponse():
      default_force_accepted(0)
    {
    }
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      union {
        bool real;
        uint8_t base;
      } u_default_force_accepted;
      u_default_force_accepted.real = this->default_force_accepted;
      *(outbuffer + offset + 0) = (u_default_force_accepted.base >> (8 * 0)) & 0xFF;
      offset += sizeof(this->default_force_accepted);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_default_force_accepted.base = 0;
      u_default_force_accepted.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->default_force_accepted = u_default_force_accepted.real;
      offset += sizeof(this->default_force_accepted);
     return offset;
    }

    const char * getType(){ return SET_DEFAULT_FORCE; };
    const char * getMD5(){ return "b3b7e5997787de41cb7b83abb2496832"; };

  };

  class set_default_force {
    public:
